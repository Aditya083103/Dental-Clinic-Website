...
<section class="services" id="services">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p>Consult with our skilled doctors for free and receive expert medical guidance to keep you at your best</p>
            <!-- <a href="#" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a> -->
        </div>
        ...
        <div class="box">
            ...
            <h3>medicines</h3>
            <p>Get free medication consultations with our pharmacists to understand and manage your prescriptions effectively</p>
            <!-- <a href="#" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a> -->
        </div>
        ...
        <div class="box">
            ...
            <h3>total care</h3>
            <p>Experience holistic well-being with our complimentary total care consultations, addressing your physical, emotional, and mental health needs</p>
            <!-- <a href="#" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a> -->
        </div>
